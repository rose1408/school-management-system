...
function ScheduleModal({ schedule, teachers, days, onClose, onSave }: ScheduleModalProps) {
  ...
  const [scheduleSlots, setScheduleSlots] = useState([
    { day: formData.day, time: formData.time, date: formData.startDate }
  ]);
        ...
        <form onSubmit={handleSubmit} className="p-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="space-y-6">
              ...
              {/* Day, Time, Dates Row */}
              <div className="space-y-4">
                <label className="block text-sm font-medium text-gray-700 mb-2">Schedule Sessions</label>
                  ...
                  <div key={index} className="grid grid-cols-3 gap-4 items-end">
                    <div>
                      ...
                      <select
                        ...
                        className="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-gray-900 bg-white text-sm"
                      >
                        {days.map(day => (
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    value={10}
                    readOnly
                    className="w-full border border-gray-300 rounded-lg px-3 py-3 bg-gray-100 text-gray-700 cursor-not-allowed"
                  />
                  <p className="text-xs text-gray-500 mt-1">Always 10 sessions per card</p>
                </div>
              </div>
            </div>
                ...
                <div className="space-y-3 max-h-80 overflow-y-auto">
                  ...
                  {previewSchedules.length === 0 && (
                    <div className="text-center text-gray-500 py-8">
                      <p>Add schedule sessions to see preview</p>
                    </div>
                  )}
                </div>
              </div>
